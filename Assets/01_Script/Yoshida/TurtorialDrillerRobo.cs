...
public class TurtorialDrillerRobo : MonoBehaviour
{
    ...
    public GameObject TurtorialCameraCtrlObj;
    ...
    private TurtorialCameraCtrl turtorialcameraCtrl;
    ...
    void Start()
    {
        ...
        turtorialcameraCtrl = TurtorialCameraCtrlObj.GetComponent<TurtorialCameraCtrl>();
    ...
    void Update()
    {
        ...
        if (Use)
        {
            ...
            if (CountLife < 0)
            {
                turtorialcameraCtrl.ChangeCamera();
            }
