...
public class TurtorialPlayerCameraCtrl : MonoBehaviour
{
    ...
    private TurtorialPlayerCtrl2 ptc;
    // Start is called before the first frame update
    void Start()
    {
        ptc = Player.GetComponentInParent<TurtorialPlayerCtrl2>();
    ...
    void Update()
    {
        ...
        {
            float r = 1;
            if (ptc.GetIfMoving() && PlayerDistancef < MinDiatancef)
            {
...
=======
>>>>>>> 8dad3b15c365899020a4fea8a3cb4b755b950c39
        TargetPos = CameraRoot.transform.position;
